    ...
    <div class="container-fluid mt-3 mb-5 px-0">
      ...
      <section class="mb-4">
        ...
        <div id="full-width-map" class="z-depth-1-half map-container" style="height: 500px">
          <iframe src="https://maps.google.com/maps?q=10.2916,123.8783&t=&z=18&ie=UTF8&iwloc=&output=embed" frameborder="0"
  ...
  <div class="row">
    ...
    <div class="col-md-9 mb-md-0 mb-5">
      ...
      <div class="text-center text-md-left">
        <a class="btn btn-primary btn-md btn-rounded">Send <i class="far fa-paper-plane ml-3"></i></a>
      </div>
    ...
    <!-- Grid column -->
    <div class="col-md-3 text-center pt-lg-5 mt-lg-3 pt-sm-0 ">
      <ul class="list-unstyled mb-0 ">
        <li >
          <a 
            ...
            target="_blank"> <i class="fas fa-map-marker-alt fa-2x blue-text"></i>
            Natalio B. Bacalso Ave, Cebu City, Cebu 6000</li></a>
        </li>
        <li>
        
          <a href="tel:+032 253 1871">   <i class="fas fa-phone fa-2x mt-4 blue-text"></i>
         (032) 253 1871</a>
        </li>
        <li>
          <!-- emaile here  -->
          <a href="mailto:webmaster@example.com?Subject=Avantrac%20Inquiry"><i class="fas fa-envelope fa-2x mt-4 blue-text"></i>
          avantrac@example.com</a>
        </li>
      </ul>
    </div>
    <!-- Grid column -->
